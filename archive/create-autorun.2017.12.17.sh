...
#
# This version was coded by OneCD and you can blame him if it all goes horribly wrong. ;)
#
# Tested on QTS 4.2.6 #20171026 running on a QNAP TS-559 Pro+.
...
Init()
	...
	local SCRIPT_VERSION='2017.12.17'
...
RemoveMountPoint()
	...
	[[ -e $DOM_mount_point && $mount_flag = false ]] && rmdir "$DOM_mount_point"
